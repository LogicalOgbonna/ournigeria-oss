-- DropForeignKey
ALTER TABLE "budget_actuals" DROP CONSTRAINT "budget_actuals_admin_id_fkey";

-- DropForeignKey
ALTER TABLE "budget_actuals" DROP CONSTRAINT "budget_actuals_economic_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_actuals" DROP CONSTRAINT "budget_actuals_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_actuals" DROP CONSTRAINT "budget_actuals_function_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_actuals" DROP CONSTRAINT "budget_actuals_programme_id_fkey";

-- DropForeignKey
ALTER TABLE "budget_actuals" DROP CONSTRAINT "budget_actuals_source_document_id_fkey";

-- DropForeignKey
ALTER TABLE "budget_admin_codes" DROP CONSTRAINT "budget_admin_codes_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_admin_codes" DROP CONSTRAINT "fk_admin_parent";

-- DropForeignKey
ALTER TABLE "budget_economic_codes" DROP CONSTRAINT "fk_economic_parent";

-- DropForeignKey
ALTER TABLE "budget_function_codes" DROP CONSTRAINT "fk_function_parent";

-- DropForeignKey
ALTER TABLE "budget_line_items" DROP CONSTRAINT "budget_line_items_admin_id_fkey";

-- DropForeignKey
ALTER TABLE "budget_line_items" DROP CONSTRAINT "budget_line_items_economic_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_line_items" DROP CONSTRAINT "budget_line_items_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_line_items" DROP CONSTRAINT "budget_line_items_function_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_line_items" DROP CONSTRAINT "budget_line_items_fund_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_line_items" DROP CONSTRAINT "budget_line_items_location_id_fkey";

-- DropForeignKey
ALTER TABLE "budget_line_items" DROP CONSTRAINT "budget_line_items_programme_id_fkey";

-- DropForeignKey
ALTER TABLE "budget_line_items" DROP CONSTRAINT "budget_line_items_source_document_id_fkey";

-- DropForeignKey
ALTER TABLE "budget_locations" DROP CONSTRAINT "budget_locations_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_metadata" DROP CONSTRAINT "budget_metadata_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "budget_programmes" DROP CONSTRAINT "budget_programmes_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "constituency_wards" DROP CONSTRAINT "constituency_wards_constituency_code_fkey";

-- DropForeignKey
ALTER TABLE "constituency_wards" DROP CONSTRAINT "constituency_wards_ward_code_fkey";

-- DropForeignKey
ALTER TABLE "debt_records" DROP CONSTRAINT "debt_records_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "documents" DROP CONSTRAINT "documents_state_code_fkey";

-- DropForeignKey
ALTER TABLE "documents" DROP CONSTRAINT "fk_documents_entity";

-- DropForeignKey
ALTER TABLE "faac_disbursements" DROP CONSTRAINT "faac_disbursements_source_document_id_fkey";

-- DropForeignKey
ALTER TABLE "faac_fgn_details" DROP CONSTRAINT "faac_fgn_details_disbursement_id_fkey";

-- DropForeignKey
ALTER TABLE "faac_lga_allocations" DROP CONSTRAINT "faac_lga_allocations_disbursement_id_fkey";

-- DropForeignKey
ALTER TABLE "faac_lga_allocations" DROP CONSTRAINT "faac_lga_allocations_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "faac_state_allocations" DROP CONSTRAINT "faac_state_allocations_disbursement_id_fkey";

-- DropForeignKey
ALTER TABLE "faac_state_allocations" DROP CONSTRAINT "faac_state_allocations_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "fiscal_entities" DROP CONSTRAINT "fk_fiscal_entity_federal";

-- DropForeignKey
ALTER TABLE "fiscal_entities" DROP CONSTRAINT "fk_fiscal_entity_lga";

-- DropForeignKey
ALTER TABLE "fiscal_entities" DROP CONSTRAINT "fk_fiscal_entity_state";

-- DropForeignKey
ALTER TABLE "gdp_records" DROP CONSTRAINT "gdp_records_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "govspend_payments" DROP CONSTRAINT "govspend_payments_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "igr_records" DROP CONSTRAINT "igr_records_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "nigerian_states" DROP CONSTRAINT "fk_states_zone";

-- DropForeignKey
ALTER TABLE "nigerian_wards" DROP CONSTRAINT "nigerian_wards_lga_code_fkey";

-- DropForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT "fk_positions_constituency";

-- DropForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT "fk_positions_lga";

-- DropForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT "fk_positions_party";

-- DropForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT "fk_positions_state";

-- DropForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT "fk_positions_term";

-- DropForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT "fk_positions_ward";

-- DropForeignKey
ALTER TABLE "political_terms" DROP CONSTRAINT "political_terms_state_code_fkey";

-- DropForeignKey
ALTER TABLE "population_estimates" DROP CONSTRAINT "population_estimates_entity_code_fkey";

-- DropForeignKey
ALTER TABLE "senatorial_district_lgas" DROP CONSTRAINT "senatorial_district_lgas_lga_code_fkey";

-- DropForeignKey
ALTER TABLE "senatorial_district_lgas" DROP CONSTRAINT "senatorial_district_lgas_senatorial_district_code_fkey";

-- DropIndex
DROP INDEX "idx_gp_beneficiary_trgm";

-- DropIndex
DROP INDEX "idx_gp_org_trgm";

-- AlterTable
ALTER TABLE "nigerian_officials" ADD COLUMN     "completeness_score" DECIMAL(3,2);

-- DropTable
DROP TABLE "unmapped_position_parties";
...
-- CreateIndex
CREATE INDEX "idx_proposals_official_status" ON "data_proposals"("official_id", "status");

-- CreateIndex
CREATE INDEX "idx_proposals_status_date" ON "data_proposals"("status", "created_at" DESC);

-- CreateIndex
CREATE INDEX "idx_proposals_phone_date" ON "data_proposals"("proposer_phone", "created_at" DESC);

-- CreateIndex
CREATE INDEX "idx_votes_phone_date" ON "proposal_votes"("voter_phone", "created_at" DESC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_vote_proposal_voter" ON "proposal_votes"("proposal_id", "voter_phone");
