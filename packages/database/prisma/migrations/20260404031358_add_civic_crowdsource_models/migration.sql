...
-- AddForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT IF EXISTS "official_positions_term_id_fkey";
...
-- AddForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT IF EXISTS "official_positions_party_acronym_fkey";
...
-- AddForeignKey
ALTER TABLE "official_positions" DROP CONSTRAINT IF EXISTS "official_positions_state_code_fkey";
...
-- AddForeignKey
ALTER TABLE "data_proposals" DROP CONSTRAINT IF EXISTS "data_proposals_official_id_fkey";
...
-- AddForeignKey
ALTER TABLE "data_proposals" DROP CONSTRAINT IF EXISTS "data_proposals_position_id_fkey";
...
-- AddForeignKey
ALTER TABLE "proposal_votes" DROP CONSTRAINT IF EXISTS "proposal_votes_proposal_id_fkey";
...
-- AddForeignKey
ALTER TABLE "documents" DROP CONSTRAINT IF EXISTS "documents_entity_code_fkey";
...
-- AddForeignKey
ALTER TABLE "fiscal_entities" DROP CONSTRAINT IF EXISTS "fiscal_entities_federal_code_fkey";
...
-- AddForeignKey
ALTER TABLE "fiscal_entities" DROP CONSTRAINT IF EXISTS "fiscal_entities_state_code_fkey";
...
-- AddForeignKey
ALTER TABLE "fiscal_entities" DROP CONSTRAINT IF EXISTS "fiscal_entities_lga_code_fkey";
...
-- AddForeignKey
ALTER TABLE "budget_admin_codes" DROP CONSTRAINT IF EXISTS "budget_admin_codes_parent_id_fkey";
...
-- AddForeignKey
ALTER TABLE "budget_function_codes" DROP CONSTRAINT IF EXISTS "budget_function_codes_parent_code_fkey";
