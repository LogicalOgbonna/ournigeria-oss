 ...
 * picks the election cycle, `?party` picks whose slate to show, `?race` pins
 * the selected contest in the hero dropdown.
 *
...
export function useHomeFilters({
  ...
  return {
    ...
    /** Selected HomeRace id, or null for the first race on offer. */
