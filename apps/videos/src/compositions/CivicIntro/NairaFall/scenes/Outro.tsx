...
const BULLETS = [
  { icon: "📊", text: "Track Nigeria's real inflation rate" },
  { icon: "💬", text: "Ask our AI how budgets address inflation" },
  { icon: "📣", text: "Demand cost-of-living policies" },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Neither Should Your Government.
          </div>
        </div>
