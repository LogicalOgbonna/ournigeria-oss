...
const BULLETS = [
  { icon: "📊", text: "Compare health spending by state" },
  { icon: "💬", text: "Ask our AI about your state's health budget" },
  { icon: "📣", text: "Demand the WHO minimum" },
];
